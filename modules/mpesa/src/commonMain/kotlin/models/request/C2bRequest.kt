 ...
 * @param msisdn This is the mobile number of the customer making the payment. Sample: MSISDN (12 digits Mobile Number) e.g. 254XXXXXXXXX.
 * @param billRefNumber This is the account number for which the customer is making the payment. This is only applicable to Customer PayBill Transactions. Sample: An alphanumeric value of up to 20 characters.
 */
@Serializable
public data class C2bRequest(
  ...
  /**
   * @param shortCode Usually, a unique number is tagged to an M-PESA pay bill/till number of the organization.
   * @param c2bCommandId This is a unique command that specifies B2C transaction type. Sample: [C2bCommandId.CustomerPayBillOnline ].
   * @param amount The amount of money being sent to the short code.
   * @param msisdn This is the mobile number of the customer making the payment. Sample: MSISDN (12 digits Mobile Number) e.g. 254XXXXXXXXX.
   * @param billRefNumber This is the account number for which the customer is making the payment. This is only applicable to Customer PayBill Transactions. Sample: An alphanumeric value of up to 20 characters.
   */
