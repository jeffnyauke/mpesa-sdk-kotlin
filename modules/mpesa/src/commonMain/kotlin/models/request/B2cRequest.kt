 ...
 * B2c request
 *
 * @param initiatorName This is an API user created by the Business Administrator of the M-PESA Bulk disbursement account that is active and authorized to initiate B2C transactions via API. Sample: initiator_1, John_Doe,John Doe
 * @param securityCredential This is the value obtained after encrypting the API initiator password. The password on Sandbox has been provisioned on the simulator. However, on production the password is created when the user is being created on the M-PESA organization portal.
 ...
 * @param partyB This is the customer mobile number  to receive the amount. The number should have the country code (254) without the plus sign.
...
public data class B2cRequest(
   ...
   * @param initiatorName This is an API user created by the Business Administrator of the M-PESA Bulk disbursement account that is active and authorized to initiate B2C transactions via API. Sample: initiator_1, John_Doe,John Doe
   * @param securityCredential This is the value obtained after encrypting the API initiator password. The password on Sandbox has been provisioned on the simulator. However, on production the password is created when the user is being created on the M-PESA organization portal.
   * @param b2cCommandId This is a unique command that specifies B2C transaction type. Sample: [B2cCommandId.SalaryPayment]
   * @param amount The amount of money being sent to the customer.
   * @param partyA This is the B2C organization shortcode from which the money is to be sent.
   * @param partyB This is the customer mobile number  to receive the amount. The number should have the country code (254) without the plus sign.
   * @param resultUrl This is the URL to be specified in your request that will be used by M-Pesa to send notification upon processing of the payment request.
