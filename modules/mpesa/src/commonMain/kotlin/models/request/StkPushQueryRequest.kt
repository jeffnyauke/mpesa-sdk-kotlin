 ...
 *
 * @param businessShortCode This is organizations shortcode (PayBill or BuyGoods - A 5 to 7-digit account number) used to identify an organization and receive the transaction. Sample: Shortcode (5 to 7 digits) e.g. 654321.
 ...
 * @param checkoutRequestId This is a global unique identifier of the processed checkout transaction request. Sample: ws_CO_DMZ_123212312_2342347678234.
 */
@Serializable
