 ...
 * Note that, this is the default action value that determines what M-PESA will do in the scenario
...
public enum class C2bRegisterTransactionType {
    ...
    /**
     * M-PESA will automatically cancel the transaction, in the event M-PESA is unable to reach your
     * Validation URL.
     */
    Cancelled,
}
